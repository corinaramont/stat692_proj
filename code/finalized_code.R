...
### Summary figures for exploratory analyses -----------------------------------

fig_data = new_data
fig_data$avg_age = (new_data$E_AGE + new_data$FU_AGE)/2
par(cex.main=1)
boxplot(avg_age~CRC,data=fig_data,
